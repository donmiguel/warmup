...
class InternalContext {
    ...
    Create(options) {
        return this.createActorFromPayload(Object.assign({}, options, { actor: Object.assign({}, (options && options.actor), { id: v4_1.default() }), type: 'create-empty' }));
    }
    CreateFromLibrary(options) {
        return this.createActorFromPayload(Object.assign({}, options, { actor: Object.assign({}, (options && options.actor), { id: v4_1.default() }), type: 'create-from-library' }));
    }
    CreateFromPrefab(options) {
        return this.createActorFromPayload(Object.assign({}, options, { actor: Object.assign({}, (options && options.actor), { id: v4_1.default() }), type: 'create-from-prefab' }));
    }
    ...
    CreateFromGltf(container, options) {
        ...
        options.actor = __1.Actor.sanitize(Object.assign({}, options.actor, { id: v4_1.default() }));

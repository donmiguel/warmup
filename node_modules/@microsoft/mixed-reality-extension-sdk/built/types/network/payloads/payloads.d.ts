 ...
 * *** KEEP ENTRIES SORTED ***
 */
export declare type PayloadType = AssetPayloadType | SyncPayloadType | 'actor-correction' | 'actor-update' | 'app2engine-rpc' | 'collision-event-raised' | 'create-animation' | 'create-empty' | 'create-from-library' | 'destroy-actors' | 'engine2app-rpc' | 'handshake' | 'handshake-complete' | 'handshake-reply' | 'heartbeat' | 'heartbeat-reply' | 'interpolate-actor' | 'multi-operation-result' | 'object-spawned' | 'operation-result' | 'perform-action' | 'rigidbody-add-force' | 'rigidbody-add-force-at-position' | 'rigidbody-add-relative-torque' | 'rigidbody-add-torque' | 'rigidbody-commands' | 'rigidbody-move-position' | 'rigidbody-move-rotation' | 'set-animation-state' | 'set-authoritative' | 'set-behavior' | 'set-media-state' | 'sync-animations' | 'sync-complete' | 'sync-request' | 'traces' | 'trigger-event-raised' | 'user-joined' | 'user-left' | 'user-update';
/**
 * @hidden

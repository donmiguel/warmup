...
class Appearance {
    constructor(actor) {
        ...
        this._meshId = constants_1.ZeroGuid;
    }
    ...
    get material() {
        return this.actor.context.internal.lookupAsset(this._materialId);
    }
    set material(value) {
    ...
    get mesh() {
        return this.actor.context.internal.lookupAsset(this._meshId);
    }
    set mesh(value) {
        this.meshId = value && value.id || constants_1.ZeroGuid;
    }
    /** @inheritdoc */

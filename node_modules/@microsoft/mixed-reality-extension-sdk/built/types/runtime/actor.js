...
const mediaInstance_1 = require("./mediaInstance");
/**
...
class Actor {
    ...
    static CreatePrimitive(container, options) {
        ...
        return Actor.Create(container.context, {
            actor: Object.assign({}, actor, { appearance: Object.assign({}, actor.appearance, { meshId: mesh.id }), collider: options.addCollider
    ...
    startSound(soundAssetId, options) {
        return new mediaInstance_1.MediaInstance(this, soundAssetId).start(options);
    }
    /**
    ...
    startVideoStream(videoStreamAssetId, options) {
        return new mediaInstance_1.MediaInstance(this, videoStreamAssetId).start(options);
    }
    /**

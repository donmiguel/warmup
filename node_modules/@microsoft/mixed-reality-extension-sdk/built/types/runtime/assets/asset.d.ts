 ...
 */
import { AssetContainer, Material, MaterialLike, Mesh, MeshLike, Prefab, PrefabLike, Sound, SoundLike, Texture, TextureLike, VideoStreamLike } from '.';
import { Actor } from '..';
/**
...
export declare abstract class Asset implements AssetLike {
    ...
    protected references: Set<Actor | Asset>;
    protected constructor(container: AssetContainer, def: Partial<AssetLike>);
    /** @hidden */
    addReference(ref: Actor | Asset): void;
    /** @hidden */
    clearReference(ref: Actor | Asset): void;
    /** @hidden */

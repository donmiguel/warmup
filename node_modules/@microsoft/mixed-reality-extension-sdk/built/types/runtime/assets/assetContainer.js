...
class AssetContainer {
    ...
    get assetsById() { return Object.freeze(Object.assign({}, this._assets)); }
    /** A list of all assets in this container */
    get assets() { return Object.values(this._assets); }
    /** A list of all materials in this container */
    get materials() { return this.assets.filter(a => a instanceof _1.Material); }
    /** A list of all meshes in this container */
    get meshes() { return this.assets.filter(a => a instanceof _1.Mesh); }
    /** A list of all prefabs in this container */
    get prefabs() { return this.assets.filter(a => a instanceof _1.Prefab); }
    /** A list of all sounds in this container */
    get sounds() { return this.assets.filter(a => a instanceof _1.Sound); }
    /** A list of all textures in this container */
    get textures() { return this.assets.filter(a => a instanceof _1.Texture); }
    /**
    ...
    createMaterial(name, definition) {
        const mat = new _1.Material(this, {
            id: v4_1.default(),
            name,
    ...
    createVideoStream(name, definition) {
        const video = new _1.VideoStream(this, {
            id: v4_1.default(),
            name,
            videoStream: resolveJsonValues_1.default(definition)
        });
    ...
    async loadGltf(uri, colliderType) {
        ...
        const response = await this.sendPayloadAndGetReply(payload);
    ...
    unload() {
        ...
        this.context.internal.nextUpdate().then(() => {
            ...
            .catch(err => log_1.log.error('app', err));
    }

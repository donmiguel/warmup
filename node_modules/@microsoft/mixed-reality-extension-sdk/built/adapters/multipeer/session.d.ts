...
import { Client, InitializeActorMessage, SyncActor, SyncAsset } from '.';
...
export declare class Session extends EventEmitter {
    ...
    readonly assets: Partial<SyncAsset>[];
    readonly assetCreators: Message<Payloads.LoadAssets | Payloads.CreateAsset>[];
    ...
    cacheAssetCreation(assetId: string, creatorId: string): void;

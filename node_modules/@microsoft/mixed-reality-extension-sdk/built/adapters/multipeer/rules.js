...
exports.Rules = {
    ...
    // ========================================================================
    'handshake': Object.assign({}, ClientOnlyRule, { client: Object.assign({}, ClientOnlyRule.client, { timeoutSeconds: 30 }) }),
    // ========================================================================
    ...
    'heartbeat': Object.assign({}, exports.DefaultRule, { synchronization: {
            ...
            during: 'allow',
            after: 'allow',
        }, client: Object.assign({}, exports.DefaultRule.client, { timeoutSeconds: 30 }) }),
    // ========================================================================
    ...
    // ========================================================================
    'set-media-state': Object.assign({}, exports.DefaultRule, { synchronization: {
            ...
            after: 'allow'
                ...
                if (syncActor) {
                    ...
                    if (message.payload.mediaCommand === __1.MediaCommand.Start) {
                        ...
                        const activeMediaInstance = syncActor.activeMediaInstances.filter(item => item.message.payload.id === message.payload.id).shift();
                        ...
                        if (message.payload.mediaCommand !== __1.MediaCommand.Stop) {
                            ...
                            activeMediaInstance.message.payload.options = Object.assign({}, activeMediaInstance.message.payload.options, message.payload.options);
    ...
    // ========================================================================
    'unload-assets': Object.assign({}, exports.DefaultRule, { synchronization: {
            stage: 'load-assets',
            before: 'ignore',
            during: 'queue',
            after: 'allow'
    ...
    // ========================================================================
    'x-reserve-actor': Object.assign({}, exports.DefaultRule, { synchronization: {
            stage: 'never',
            before: 'ignore',
            during: 'ignore',
            after: 'ignore'
